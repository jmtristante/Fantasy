-- 0022_operacion_mercado_atomica.sql
-- Registrar una operación de mercado (compra/venta/transferencia) de forma
-- atómica. Antes cada paso se lanzaba como una promesa independiente y un
-- fallo parcial dejaba el movimiento registrado pero al jugador en la
-- plantilla del vendedor (o sin añadirlo al comprador).
--   * p_comprador / p_vendedor: 0 significa LaLiga (el banco).
--   * Las notas se calculan en el cliente y se pasan ya formateadas.
